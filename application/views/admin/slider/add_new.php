					...
					<div class="col-md-6 mt-2">
						...
						<div class="card card-primary">
							<div class="card-header">
								<h3 class="card-title">Yeni Slider</h3>
							</div>
							<!-- /.card-header -->
							<!-- form start -->
							<form method="post" action="<?=base_url()?>admin/slider/insert" enctype="multipart/form-data">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input type="text" name="summary" class="form-control" id="summary" placeholder="Məlumat">
									</div>
									<div class="form-group">
										...
										<select name="slider_news_id" class="form-control" required>
											...
											<?php foreach ( $news as $newsValue ): ?>
												<option value="<?= $newsValue['id'] ?>"> <?= $newsValue['title'] ?> </option>
											<?php endforeach; ?>
										</select>
									</div>
									<div class="form-group">
										...
										<div class="input-group">
											<div class="custom-file">
												<input type="file" name="slider_image" class="custom-file-input" id="slider_image" required>
